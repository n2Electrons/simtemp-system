...
- [Challenge 2025 Temperature Sensor System with Octave Integration](#challenge-2025-temperature-sensor-system-with-octave-integration)
  ...
  - [QEMU Infrastructure](#qemu-infrastructure)
    ...
    - [DTB Overlay Integration](#dtb-overlay-integration)
